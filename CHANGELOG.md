...
- Added `docs/honest-gwt-report.md`, `docs/dogfood-report.md`, publishing
  guidance, a docs index, and a GitHub Pages workflow for the Markdown docs.
- Refreshed `v0.3.0` release readiness with local MCP dogfood, Codex MCP
  health, external subscriber POC, and bounded Qwen `max-tasks=2` evidence.
